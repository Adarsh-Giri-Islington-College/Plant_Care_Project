...
class UserManager(BaseUserManager):
    def create_user(self, user_image, username, email, first_name, last_name, address, is_banned=False, ban_until=None, created_time=None, password=None, is_staff=False):
        if not email:
...
class User(AbstractBaseUser):
    ...
    user_image = models.ImageField(upload_to='user_images/', null=True, blank=True, default='user_images/profile_image.jpg') 
